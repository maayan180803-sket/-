...
export const FIXTURE_EXPENSES: Expense[] = [
  { id: 'e1', household_id: HOUSEHOLD_ID, name: 'שכירות', amount: 5500, expense_date: d(2), category: 'שכירות', paid_by_type: 'shared', paid_by_member_id: null, belongs_to_type: 'shared', belongs_to_member_id: null, payment_method: 'העברה בנקאית', is_recurring: true, recurring_expense_id: null, split_override: null, notes: null, created_by: USER_ID, updated_by: USER_ID, created_at: iso, updated_at: iso },
  { id: 'e2', household_id: HOUSEHOLD_ID, name: 'ארנונה', amount: 450, expense_date: d(4), category: 'ארנונה', paid_by_type: 'member', paid_by_member_id: MAAYAN_ID, belongs_to_type: 'shared', belongs_to_member_id: null, payment_method: 'הוראת קבע', is_recurring: true, recurring_expense_id: null, split_override: null, notes: null, created_by: USER_ID, updated_by: USER_ID, created_at: iso, updated_at: iso },
  { id: 'e3', household_id: HOUSEHOLD_ID, name: 'חשמל', amount: 380, expense_date: d(10), category: 'חשמל', paid_by_type: 'member', paid_by_member_id: ADI_ID, belongs_to_type: 'shared', belongs_to_member_id: null, payment_method: 'הוראת קבע', is_recurring: false, recurring_expense_id: null, split_override: null, notes: null, created_by: USER_ID, updated_by: USER_ID, created_at: iso, updated_at: iso },
  { id: 'e4', household_id: HOUSEHOLD_ID, name: 'סופר שבועי', amount: 620, expense_date: d(12), category: 'סופר', paid_by_type: 'member', paid_by_member_id: MAAYAN_ID, belongs_to_type: 'shared', belongs_to_member_id: null, payment_method: 'אשראי', is_recurring: false, recurring_expense_id: null, split_override: null, notes: null, created_by: USER_ID, updated_by: USER_ID, created_at: iso, updated_at: iso },
  { id: 'e5', household_id: HOUSEHOLD_ID, name: 'ארוחה בחוץ', amount: 210, expense_date: d(14), category: 'מסעדות', paid_by_type: 'member', paid_by_member_id: ADI_ID, belongs_to_type: 'shared', belongs_to_member_id: null, payment_method: 'אשראי', is_recurring: false, recurring_expense_id: null, split_override: null, notes: 'יום הולדת', created_by: USER_ID, updated_by: USER_ID, created_at: iso, updated_at: iso },
  { id: 'e6', household_id: HOUSEHOLD_ID, name: 'דלק', amount: 350, expense_date: d(15), category: 'דלק', paid_by_type: 'member', paid_by_member_id: MAAYAN_ID, belongs_to_type: 'member', belongs_to_member_id: MAAYAN_ID, payment_method: 'אשראי', is_recurring: false, recurring_expense_id: null, split_override: null, notes: null, created_by: USER_ID, updated_by: USER_ID, created_at: iso, updated_at: iso },
];
